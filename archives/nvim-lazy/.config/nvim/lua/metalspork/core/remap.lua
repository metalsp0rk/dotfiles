...
vim.keymap.set("n", "<leader>D", ":bdelete<CR>", { noremap = true, silent = true, desc = "Close buffer and split"})
...
vim.keymap.set("n", "<leader>fx", ":!chmod +x %<CR>", { desc="Make file executable", noremap = true, silent = true })
...
vim.keymap.set('n', '<leader>tl', "<CMD>Lazy<CR>", {silent = true, desc = "Open Lazy Dialog"})
